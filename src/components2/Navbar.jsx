    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-black">
        ...
        <nav className="hidden md:flex space-x-6">
            ...
            className="relative text-white group">
                ...
                bg-yellow-500 transition-all duration-300 group-hover:h-[20px] 
        ...
        <button className="md:hidden text-white hover:text-yellow-400 ml-auto"
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-md">
          <button onClick={() => {
            ...
            className="block w-full text-left px-6 py-2 text-gray-700 hover:bg-yellow-400 
